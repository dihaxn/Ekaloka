          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <ul className="space-y-3">
                {['New Arrivals', 'Best Sellers', 'Seasonal Collections', 'Limited Editions', 'Sale Items'].map((item, index) => (
                    <motion.li
                        key={index}
                        whileHover={{ x: 5 }}
                        transition={{ type: "spring", stiffness: 300 }}
                    >
                      <a href="#" className="flex items-center text-gray-300 hover:text-amber-400 transition-colors">
            ...
            <motion.div
                ...
                className="space-y-4"
            >
              <h3 className="text-lg font-semibold border-b border-amber-500 pb-2 w-fit">Newsletter</h3>
              <p className="text-gray-300 text-sm">
              ...
              <form className="space-y-4">
                <div className="relative">
                  <input
                      ...
                      className="w-full p-3 bg-gray-800 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                  />
                  <button
                      type="submit"
                      className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-amber-500 text-black px-4 py-1 rounded-lg hover:bg-amber-400 transition-colors"
                  >
                    Join
                  </button>
                </div>
