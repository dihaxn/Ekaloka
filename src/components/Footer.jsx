    ...
    <div className='container mx-auto px-4 py-12'>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
        ...
        <div className='space-y-6'>
          ...
          <p className='text-sm'>
            Where elegance meets modern style. We bring you the latest trends
            and timeless classics to elevate your wardrobe and express your
            unique personality.
          </p>
        ...
        <div className='space-y-4'>
          <h3 className='text-lg font-semibold border-b border-amber-500 pb-2 w-fit'>
            Quick Links
          </h3>
        ...
        <div className='space-y-4'>
          ...
          <div className='grid grid-cols-2 gap-3'>
            {categories.map((category, index) => (
              ...
              >
                <span className='font-medium group-hover:text-amber-400'>
                  {category.name}
                </span>
