...
const products = [
  ...
  },
  {
    ...
    description: "Discover pieces that reflect your unique lifestyle and personality.",
  },
  {
    id: 3,
          ...
          <div key={id} className="relative group">
            ...
            <div className="group-hover:-translate-y-4 transition duration-300 absolute bottom-8 left-8 text-white space-y-2">
              ...
              <button className="flex items-center gap-1.5 bg-amber-900 hover:bg-amber-800 px-4 py-2 rounded transition-colors duration-300">
                Shop Now <Image className="h-3 w-3" src={assets.redirect_icon} alt="Redirect Icon" width={12} height={12} />
              </button>
            </div>
          </div>
        ))}
