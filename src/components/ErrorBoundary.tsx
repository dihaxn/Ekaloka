...
function useErrorBoundary() {
  ...
  useEffect(() => {
    const handleError = (event: ErrorEvent) => {
      ...
      setErrorInfo({ componentStack: event.error?.stack || 'Unknown error location' })
      
      // Log error to console
      console.error('ErrorBoundary caught an error:', event.error, event.error?.stack)
    ...
    const handleUnhandledRejection = (event: PromiseRejectionEvent) => {
      ...
      console.error('ErrorBoundary caught an unhandled rejection:', error, error.stack)
    }
