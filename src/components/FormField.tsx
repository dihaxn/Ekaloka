...
export function useFormValidation<T extends Record<string, any>>(
  initialData: T,
  validationSchema: Record<keyof T, Array<(value: T[keyof T], fieldName: string) => ValidationError | null>>
) {
  const [data, setData] = useState<T>(initialData)
  const [errors, setErrors] = useState<Record<keyof T, ValidationError | null>>({} as any)
  const [touched, setTouched] = useState<Record<keyof T, boolean>>({} as any)

  const validateField = (field: keyof T, value: T[keyof T]): ValidationError | null => {
