      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500">
            Try uploading an image to see if the preview displays without CSP errors.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {uploadStatus && (
              <div className="text-center">
                <div className={`text-sm font-medium ${
                  uploadStatus.includes('successfully') ? 'text-green-400' : 
          ...
          <div className="bg-gray-800 p-6 rounded-lg">
            ...
            <div className="space-y-4">
              ...
              {testImage && (
                <div className="text-center">
                  <div className="text-green-400 text-sm">✅ Image preview working!</div>
        ...
        <div className="mt-8 bg-gray-800 p-6 rounded-lg">
          ...
          <ol className="text-gray-300 space-y-2 list-decimal list-inside">
            ...
            <li>Verify that both the ImageUpload and ProfilePicture components work</li>
          </ol>
        </div>
        ...
        <div className="mt-6 text-center">
          <div className="text-sm text-gray-400">
            Current Status: {testImage ? 'Image loaded successfully' : 'No image uploaded yet'}
          </div>
        </div>
      </div>
    </div>
