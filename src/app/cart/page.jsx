...
const Cart = () => {
  ...
  const { products, router, cartItems, addToCart, updateCartQuantity, getCartCount, loading, canAccessCart, isAdmin, userRole } = useAppContext();
        ...
        <div className="flex flex-col items-center justify-center min-h-screen px-6">
          <div className="text-center max-w-md">
            <div className="mb-6">
              ...
              <p className="text-gray-400 text-lg">Cart functionality is not available for admin users</p>
            </div>
            
            <div className="bg-gray-800/50 rounded-lg p-6 mb-6">
              <h2 className="text-xl font-semibold text-white mb-3">Current User Info:</h2>
              <div className="space-y-2 text-sm text-gray-300">
                <div><strong>Role:</strong> {userRole}</div>
                <div><strong>Cart Access:</strong> ❌ Restricted</div>
                <div><strong>Admin Status:</strong> ✅ Yes</div>
              </div>
            </div>
    ...
    <div className="bg-gradient-to-r from-black via-gray-900 to-black">
      ...
      <div className="flex flex-col md:flex-row gap-10 px-6 md:px-16 lg:px-32 pt-14 mb-20">
        <div className="flex-1">
          ...
          <button onClick={()=> router.push('/all-products')} className="group flex items-center mt-6 gap-2 text-amber-600">
            <Image
