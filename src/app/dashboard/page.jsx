                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center py-6">
                        <div className="flex items-center">
                            ...
                            <h1 className="ml-3 text-2xl font-bold text-white">Dai Fashion</h1>
                        </div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                            ...
                            <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p className="text-green-200">
                                        You've successfully signed in with {user.provider}. Your account is now active.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-lg font-semibold text-white">{user.loginTime}</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-8 bg-gray-900 border border-gray-800 rounded-lg p-6">
                    ...
                    <p className="text-gray-300 mb-4">
                        Your OAuth authentication system is now fully functional! Here's what you can do next:
                    </p>
