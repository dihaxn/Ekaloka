    ...
    return (
        <div className="bg-gradient-to-r from-black via-gray-900 to-black">
            ...
            <main className="pt-24">
                ...
                <section className="py-20 px-4 md:px-8">
                    <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
                        <div className="relative h-80 rounded-lg overflow-hidden shadow-2xl animate-fadeIn" style={{ animationDelay: '0.4s' }}>
                            <Image
                        ...
                        <div className="animate-fadeIn" style={{ animationDelay: '0.6s' }}>
                            ...
                            <p className="text-gray-400 mb-4">
                                Our state-of-the-art fashion studio is where creativity meets innovation. Here, our talented designers bring your fashion dreams to life, combining traditional craftsmanship with cutting-edge technology.
                            </p>
                            <p className="text-gray-400">
                                Every collection starts with inspiration, evolves through collaboration, and culminates in pieces that reflect both current trends and timeless elegance. Our studio is more than a workspace—it's the heart of Dai Fashion.
                            </p>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container mx-auto text-center">
                        ...
                        <div className="grid md:grid-cols-3 gap-10">
                            {teamMembers.map((member, index) => (
                                <div key={index} className="group bg-gray-800/50 p-6 rounded-lg text-center shadow-xl transform hover:scale-105 transition-all duration-300 hover:bg-gray-800/70 border border-transparent hover:border-amber-500/30">
                                    ...
                                    <h3 className="text-xl font-bold text-white group-hover:text-amber-300 transition-colors duration-300">{member.name}</h3>
