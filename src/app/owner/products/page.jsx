...
const ProductList = () => {
    ...
    const categories = ['All', 'Fashion', 'Clothing', 'Accessories', 'Shoes', 'Bags']
    ...
    const getStatusColor = (status) => {
        switch (status) {
            ...
            case 'Low Stock': return 'text-yellow-400 bg-yellow-500/20'
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-700/50">
                                    ...
                                    <th className="text-left py-3 px-4 text-white font-medium">SKU</th>
                                    <th className="text-left py-3 px-4 text-white font-medium">Category</th>
                                    <th className="text-left py-3 px-4 text-white font-medium">Price</th>
                                    <th className="text-left py-3 px-4 text-white font-medium">Stock</th>
                                    <th className="text-left py-3 px-4 text-white font-medium">Sales</th>
                            ...
                            <tbody>
                                {filteredProducts.map((product) => (
                                    <tr key={product._id} className="border-b border-gray-700/30 hover:bg-gray-700/20 transition-colors">
                                        ...
                                        <td className="py-3 px-4">
                                            <div>
                                                <p className="text-white font-medium">${product.offerPrice}</p>
