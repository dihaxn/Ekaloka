...
const OrderManagement = () => {
    ...
    const mockOrders = [
        ...
        },
        {
            ...
            products: [
                { name: 'Lifestyle Fashion Bundle', quantity: 1, price: 159 }
            ],
            total: 159,
            status: 'Shipped',
            date: '2024-01-13',
        ...
        },
        {
            ...
            products: [
                { name: 'Elegant Evening Wear', quantity: 1, price: 499 }
            ],
            total: 499,
            status: 'Delivered',
            date: '2024-01-12',
                        ...
                        <table className="w-full">
                            <thead>
                                <tr className="border-b border-gray-700/50">
                                    <th className="text-left py-3 px-4 text-white font-medium">Order ID</th>
                                    <th className="text-left py-3 px-4 text-white font-medium">Customer</th>
                                    <th className="text-left py-3 px-4 text-white font-medium">Products</th>
                                    <th className="text-left py-3 px-4 text-white font-medium">Total</th>
                            ...
                            <tbody>
                                {filteredOrders.map((order) => (
                                    <tr key={order.id} className="border-b border-gray-700/30 hover:bg-gray-700/20 transition-colors">
                                        ...
                                        <td className="py-3 px-4">
                                            <p className="text-white font-medium">{currency}{order.total}</p>
                                        </td>
                                        <td className="py-3 px-4">
