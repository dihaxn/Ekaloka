              ...
              <div className='space-y-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        handleStoreSettingsChange('storeEmail', e.target.value)
                      }
                      className='w-full outline-none py-3 px-4 rounded-lg border border-gray-500/40 bg-gray-900/50 text-white focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/30 transition-all duration-300'
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        handleStoreSettingsChange('storePhone', e.target.value)
                      }
                      className='w-full outline-none py-3 px-4 rounded-lg border border-gray-500/40 bg-gray-900/50 text-white focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/30 transition-all duration-300'
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={e =>
                        handleStoreSettingsChange('currency', e.target.value)
                      }
                      className='w-full outline-none py-3 px-4 rounded-lg border border-gray-500/40 bg-gray-900/50 text-white focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/30 transition-all duration-300'
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={e =>
                      handleStoreSettingsChange('storeAddress', e.target.value)
                    }
                    className='w-full outline-none py-3 px-4 rounded-lg border border-gray-500/40 bg-gray-900/50 text-white focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/30 transition-all duration-300'
                  />
                </div>
                    ...
                    >
                      <div>
                        ...
                        <p className='text-gray-400 text-sm'>
                          ...
                          {key === 'customerSignups' &&
                            'Notification for new customer registrations'}
                          {key === 'weeklyReports' &&
                            'Receive weekly performance reports'}
                          {key === 'monthlyReports' &&
                            'Receive monthly business summaries'}
                          {key === 'marketingEmails' &&
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  <div>
                    ...
                    <select
                      ...
                      onChange={e =>
                        handleAppearanceSettingsChange('theme', e.target.value)
                      }
                      className='w-full outline-none py-3 px-4 rounded-lg border border-gray-500/40 bg-gray-900/50 text-white focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/30 transition-all duration-300'
                    >
