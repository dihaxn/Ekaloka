        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-400 max-w-2xl mx-auto'>
              Experience the complete profile picture upload system with drag &
              drop, real-time preview, and smart fallback avatars.
            </p>
          </div>
