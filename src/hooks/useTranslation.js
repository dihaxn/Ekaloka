...
const translations = {
    en: {
        ...
        errors: {
            ...
            rateLimit: {
                withTime: 'Too many login attempts. Please wait {seconds} seconds before trying again.',
    ...
    es: {
        ...
        errors: {
            ...
            rateLimit: {
                withTime: 'Demasiados intentos de login. Por favor espera {seconds} segundos antes de intentar de nuevo.',
                generic: 'Demasiados intentos de login. Por favor espera antes de intentar de nuevo.'
            },
            invalidCredentials: 'Credenciales de login inválidas. Por favor verifica tu email y contraseña.',
            generic: 'Ocurrió un error. Por favor intenta de nuevo.',
            mfa: {
                invalid: 'Código de autenticación inválido. Por favor intenta de nuevo.',
                failed: 'Verificación MFA falló. Por favor intenta de nuevo.',
                webauthn: 'Autenticación con clave de seguridad falló. Por favor intenta de nuevo.'
            }
        },
        // Footer
        footer: {
    ...
    fr: {
        ...
        errors: {
            ...
            rateLimit: {
                withTime: 'Trop de tentatives de connexion. Veuillez attendre {seconds} secondes avant de réessayer.',
                generic: 'Trop de tentatives de connexion. Veuillez attendre avant de réessayer.'
            },
            invalidCredentials: 'Identifiants de connexion invalides. Veuillez vérifier votre email et mot de passe.',
            ...
            mfa: {
                ...
                webauthn: 'L\'authentification par clé de sécurité a échoué. Veuillez réessayer.'
            }
        },
        // Footer
        footer: {
