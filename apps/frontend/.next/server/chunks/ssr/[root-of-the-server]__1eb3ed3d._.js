...
const AppContextProvider = (props)=>{
    ...
    const [isSeller, setIsSeller] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // Placeholder for seller logic
    ...
    const loginUser = async (userData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${url}/api/user/login`, userData);
            if (response.data.success) {
    ...
    const registerUser = async (userData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${url}/api/user/register`, userData);
            if (response.data.success) {
                return {
                    success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1eb3ed3d._.js.map